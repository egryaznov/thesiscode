...
public class MaritalBond extends Bond
{
    ...
    MaritalBond(final @NotNull Node firstNode, final @NotNull Node secondNode, final String dateOfWedding)
    {
    ...
    {
        // There are two marital bonds between those nodes, since the marital relation is symmetric
